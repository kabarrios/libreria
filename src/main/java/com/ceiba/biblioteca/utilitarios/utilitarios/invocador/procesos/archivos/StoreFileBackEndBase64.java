...
public class StoreFileBackEndBase64  extends BackendIntegracion implements Serializable{
	 ...
	 * en el tag NameFile del header del requerimiento, el string debe estar en base64 para poder ser
